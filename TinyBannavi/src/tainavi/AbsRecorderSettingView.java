...
public abstract class AbsRecorderSettingView extends JScrollPane {
	...
	private JPanel getJPanel_recorder() {
		if (jPanel_recorder == null)
		{
			...
			int yz = y;
			CommonSwingUtils.putComponentOn(jPanel_recorder, getJButton_recorderup("上へ"), BUTTON_WIDTH, PARTS_HEIGHT, table_w-BUTTON_WIDTH, yz);
			CommonSwingUtils.putComponentOn(jPanel_recorder, getJButton_recorderdown("下へ"), BUTTON_WIDTH, PARTS_HEIGHT, table_w-BUTTON_WIDTH, yz+=(PARTS_HEIGHT+SEP_HEIGHT_NALLOW));
			
			yz += (PARTS_HEIGHT+SEP_HEIGHT_NALLOW)*3;
			
			CommonSwingUtils.putComponentOn(jPanel_recorder, getJButton_recorderadd("登録"), BUTTON_WIDTH, PARTS_HEIGHT, table_w-BUTTON_WIDTH, yz);
			CommonSwingUtils.putComponentOn(jPanel_recorder, getJButton_recorderupd("置換"), BUTTON_WIDTH, PARTS_HEIGHT, table_w-BUTTON_WIDTH, yz+=(PARTS_HEIGHT+SEP_HEIGHT_NALLOW));
			CommonSwingUtils.putComponentOn(jPanel_recorder, getJButton_recorderdel("削除"), BUTTON_WIDTH, PARTS_HEIGHT, table_w-BUTTON_WIDTH, yz+=(PARTS_HEIGHT+SEP_HEIGHT_NALLOW));
