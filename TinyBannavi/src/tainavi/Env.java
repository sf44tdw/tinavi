...
public class Env {
	...
	private static final String CS_SITE = "スカパー！";
	private static final String CS2_SITE = "webザテレビジョン(CSデジ)";
	...
	public int getPageIndex(int n) {
		...
		return (n-rem)/centerPerPage + ((rem==0)?(0):(1)) - 1;
	}
	...
	public Env() {
		...
		}
		{
			...
			tv = new TextValueSet();
			tv.setText("CHAN-TORUの予約ページを開く");
			tv.setValue("https://tv.so-net.ne.jp/chan-toru/detail?type=bytime&cat=%TVKCAT%&area=%TVKAREACODE%&pid=%TVKPID%");
			al.add(tv);
